...
class GN_Mailer
{
    ...
    /**
     * @param GN_SmtpGmail $gmail
     */
    public function setGmail(GN_SmtpGmail $gmail)
    {
        if (empty($gmail->email)) throw new Exception('No email set');

        if (empty($gmail->token)) throw new Exception('No token set');
        ...
        $this->smtp = $gmail;
        $this->IsSMTP();
        $this->SetFrom($gmail->email, $gmail->fullname);
    }
}
